...
async function main() {
  ...
  // Products
  const products = [
    { name: "Cimol Bojot Original",      slug: "cimol-bojot-original",     description: "Cimol klasik dengan tepung kanji premium. Gurih, kenyal, dan bikin nagih!",                price: 15000, categoryId: original.id, isFeatured: true,  spicyLevel: 2, weight: "200g" },
    { name: "Cimol Isi Keju Mozarella",  slug: "cimol-isi-keju-mozarella", description: "Cimol kenyal isi keju mozarella yang meleleh di setiap gigitan.",                         price: 20000, categoryId: isi.id,      isFeatured: true,  spicyLevel: 1, weight: "200g" },
    { name: "Cimol Isi Ayam Pedas",      slug: "cimol-isi-ayam-pedas",     description: "Cimol kenyal isi ayam suwir berbumbu pedas. Cocok untuk pecinta pedas!",                  price: 18000, categoryId: isi.id,      isFeatured: true,  spicyLevel: 3, weight: "200g" },
    { name: "Cimol Frozen Original 500g", slug: "cimol-frozen-original",   description: "Cimol original dalam kemasan frozen. Praktis, tahan 3 bulan di freezer.",                 price: 35000, categoryId: frozen.id,   isFeatured: false, spicyLevel: 0, weight: "500g" },
    { name: "Cimol Frozen Keju 500g",    slug: "cimol-frozen-keju",        description: "Cimol isi keju dalam kemasan frozen. Stok di rumah, goreng kapanpun!",                    price: 45000, categoryId: frozen.id,   isFeatured: false, spicyLevel: 0, weight: "500g" },
    { name: "Paket Hemat Duo",           slug: "paket-hemat-duo",          description: "2 porsi cimol original + 2 minuman. Hemat dan mengenyangkan untuk berdua!",               price: 25000, categoryId: paket.id,    isFeatured: true,  spicyLevel: 1, weight: "400g" },
  ];
